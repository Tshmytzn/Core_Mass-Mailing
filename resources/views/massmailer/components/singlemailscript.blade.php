        ...
        success: function(response) {
            ...
            response.data.forEach((element, index) => {
                ...
                anchor.onclick = function () {
                    ...
                    document.getElementById('mail-to').value = element.smh_mailto;
                    document.getElementById('mail-subject').value = element.smh_subject;
                    document.getElementById('emailContent').innerHTML = element.smh_content;
                };
